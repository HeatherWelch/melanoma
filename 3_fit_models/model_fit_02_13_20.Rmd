...
fm1 <- lmer(SEER_rate ~ UV_daily_dose + (UV_daily_dose | STATEFP), modDF)
fm2=lm(SEER_rate ~ UV_daily_dose,data=modDF)
abline(lm(SEER_rate ~ UV_daily_dose,data=modDF))
fm3 <- lmer(SEER_rate ~ UV_daily_dose + (UV_daily_dose || STATEFP), modDF)
fm4 <- lmer(SEER_rate ~ UV_daily_dose + (1|STATEFP), data = modDF)
fm5 <- lmer(SEER_rate ~ UV_daily_dose, data = modDF)


ggplot()+geom_point(data=modDF,aes(x=UV_daily_dose,y=SEER_rate))

+geom_abline(slope=8.116e-04,intercept = 4.757e+01)
#most curvey
