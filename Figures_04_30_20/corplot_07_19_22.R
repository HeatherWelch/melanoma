...
library(corrplot)
outdir="/Users/heatherwelch/Dropbox/melenoma/Figures_07_19_22";dir.create(outdir)
master=read.csv("/Users/heatherwelch/Dropbox/melenoma/Figures_12_02_21/master_dataframe_12_02_21.csv") %>% 
  dplyr::select(c(Melanoma_incidence,cancer_gov_UV_exposure,seasonality_cloud,seasonality_temperature,incm_mh,pcp_pk,derm_pk,))
