...
library(corrplot)
outdir="/Users/heatherwelch/Dropbox/melenoma/Figures_12_02_21"
master=read.csv("/Users/heatherwelch/Dropbox/melenoma/Figures_12_02_21/master_dataframe_12_02_21.csv") %>% dplyr::select(c(Melanoma_incidence,cancer_gov_UV_exposure,elevation,seasonality_cloud,seasonality_temperature,UV_irradiance,incm_mh,incm_pc,wpovr50,pcp_pk,derm_pk,Melanoma_incidence_pop))
...
master=read.csv("/Users/heatherwelch/Dropbox/melenoma/Figures_12_02_21/master_dataframe_12_02_21.csv") 
colnames(master) <- make.unique(names(master))
...
write.csv(new2,"/Users/heatherwelch/Dropbox/melenoma/Figures_12_02_21/Final_dataframe_for_paper_12-02-21.csv")
